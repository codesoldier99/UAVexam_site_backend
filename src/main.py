...
from src.routers import batch_operations, wx_miniprogram, qrcode_checkin, realtime, rbac
...
app.include_router(wx_miniprogram.router)
app.include_router(qrcode_checkin.router)
