...
// 微信小程序专用 - 创建QRCode对象
var QRCode = function(canvasId, options) {
  this._options = {
    typeNumber: 4,
...
QRCode.prototype.makeCode = function(text) {
  this._oQRCode = new QRCodeModel(_getTypeNumber(text, this._options.correctLevel), this._options.correctLevel);
...
QRCode.prototype.makeImage = function() {
  var _this = this;
  var ctx = wx.createCanvasContext(this._canvasId);
  var _options = this._options;
  var moduleCount = this._oQRCode.getModuleCount();
  var tileW = _options.width / moduleCount;
  var tileH = _options.height / moduleCount;
  ...
  for (var row = 0; row < moduleCount; row++) {
    for (var col = 0; col < moduleCount; col++) {
      ...
      ctx.setFillStyle(isDark ? _options.colorDark : _options.colorLight);
  ...
  ctx.draw(false, function() {
    if (typeof _this._options.callback === 'function') {
